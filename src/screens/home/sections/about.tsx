		...
		<section className="pt-[11.938rem] pb-7 grid place-items-center">
			<section className="max-w-[1440px] w-screen mx-auto gap-[5.292rem] px-[4.063rem] flex ">
				...
				<article className="max-w-[34.063rem] grid gap-y-3 place-content-start">
					...
					<Typography variant="h4" font="title" lineHeight="72" color={"primary1300"}>
						Bridging the gap between patient and provider.
					</Typography>
					<Typography variant="body-xl" color={"neutral800"} fontWeight={"light"} customClassName="mt-3 max-w-[33rem]">
						...
						access to specialized medical expertise. <br/><br/> I'm Arinze Ikeme, MD,
						FACP, a U.S.-based Internist and Nephrologist with over 12 years of
