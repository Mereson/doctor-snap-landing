...
export const PricingSection = () => {
	...
	return (
		<section className="grid place-content-center bg-[#FEFBFB] pt-12.5 pb-30 sm:pb-[10.938rem]">
			<section className="max-w-[1440px] mx-auto grid place-content-center">
				...
				<Typography variant="body-l" color={"tertiary700"} align="center" customClassName="max-[375px]:px-7 px-13 max-sm:text-base leading-[32px]">
