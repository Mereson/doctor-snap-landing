...
export const AboutHero = () => {
	...
	return (
		<section className="pt-46 pb-[6.158rem] grid place-content-center">
			<section className="max-w-[1440px] w-screen mx-auto pl-18 pr-16.5 flex gap-[4.438rem] items-center">
				<article className="grid gap-6 max-w-[41.563rem]">
					...
					<Typography variant="body-l" color={"primary1300"}>
						Discover the fascinating world of Doctor Snap and learn more about
						the innovative Doctor Ikeme behind this remarkable service.
					</Typography>
