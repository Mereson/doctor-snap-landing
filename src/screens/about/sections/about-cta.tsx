...
export const AboutCTA = () => {
	return (
		<section className="bg-linear-[180deg,#0D2329_0%,#153842_50%,#1D4D5A_100%] grid place-content-center">
			<section className="max-w-[1440px] mx-auto grid gap-6 place-items-center relative pt-[4.924rem] pb-24.5">
				<img
					src="/svgs/dots2.svg"
					className="absolute top-[2.884rem] left-[7.721rem]"
					alt="dots"
				/>
				<Typography
					variant="h4"
					font="title"
					align="center"
					customClassName=" leading-[57.6px] max-w-2xl"
					color={"neutral100"}
				>
				...
				<Typography
					...
					align="center"
					color={"primary200"}
					customClassName="max-w-[34.688rem]"
				>
